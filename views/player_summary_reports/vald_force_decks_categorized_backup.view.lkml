# The name of this view in Looker is "Vald Force Decks Categorized Backup"
view: vald_force_decks_categorized_backup {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `player_summary_reports.vald_force_decks_categorized_backup` ;;
