# The name of this view in Looker is "Force Decks and Performance for Leaderboards V2test"
view: force_decks_and_performance_for_leaderboards_v2test {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `player_summary_reports.force_decks_and_performance_for_leaderboards_v2test` ;;
  ...
  measure: count {
    type: count
    drill_fields: [last_name, rostered_club_name, full_name]
  }
}
