# The name of this view in Looker is "Player Summary Reports Range of Motion Flags"
view: player_summary_reports_range_of_motion_flags {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `player_summary_reports.range_of_motion_flags` ;;
