# The name of this view in Looker is "Injury Transactions for Player Summary"
view: injury_transactions_for_player_summary {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `player_summary_reports.injury_transactions_for_player_summary` ;;
