# The name of this view in Looker is "Player Summary Reports Functional Movement Assessments for Player Summary"
view: player_summary_reports_functional_movement_assessments_for_player_summary {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `player_summary_reports.functional_movement_assessments_for_player_summary` ;;
