# The name of this view in Looker is "Weight and Body Composition Mlb Federated"
view: weight_and_body_composition_mlb_federated {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `strength_and_conditioning.weight_and_body_composition_mlb_federated` ;;
