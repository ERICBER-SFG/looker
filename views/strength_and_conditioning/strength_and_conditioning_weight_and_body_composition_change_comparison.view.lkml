# The name of this view in Looker is "Strength and Conditioning Weight and Body Composition Change Comparison"
view: strength_and_conditioning_weight_and_body_composition_change_comparison {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `strength_and_conditioning.weight_and_body_composition_change_comparison` ;;
