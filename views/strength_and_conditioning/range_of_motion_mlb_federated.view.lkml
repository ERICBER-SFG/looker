# The name of this view in Looker is "Range of Motion Mlb Federated"
view: range_of_motion_mlb_federated {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `strength_and_conditioning.range_of_motion_mlb_federated` ;;
