# The name of this view in Looker is "Force Decks Rehab List Milb Federated"
view: force_decks_rehab_list_milb_federated {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `strength_and_conditioning.force_decks_rehab_list_milb_federated` ;;
