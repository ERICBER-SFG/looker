# The name of this view in Looker is "Training Sprint Workload Milb Federated"
view: training_sprint_workload_milb_federated {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `strength_and_conditioning.training_sprint_workload_milb_federated` ;;
