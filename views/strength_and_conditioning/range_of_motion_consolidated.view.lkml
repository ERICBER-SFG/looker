# The name of this view in Looker is "Range of Motion Consolidated"
view: range_of_motion_consolidated {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `strength_and_conditioning.range_of_motion_consolidated` ;;
  ...
  dimension: left_thoracic_spine_rotation_degrees_degrees {
    type: number
    sql: ${TABLE}.left_thoracic_spine_rotation_degrees_degrees ;;
  }
  ...
  dimension: right_thoracic_spine_rotation_degrees_degrees {
    type: number
    sql: ${TABLE}.right_thoracic_spine_rotation_degrees_degrees ;;
  }
