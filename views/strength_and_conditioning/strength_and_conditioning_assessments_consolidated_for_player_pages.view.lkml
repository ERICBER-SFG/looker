# The name of this view in Looker is "Strength and Conditioning Assessments Consolidated for Player Pages"
view: strength_and_conditioning_assessments_consolidated_for_player_pages {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `strength_and_conditioning.strength_and_conditioning_assessments_consolidated_for_player_pages` ;;
