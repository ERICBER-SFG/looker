# The name of this view in Looker is "Functional Movement Assessments"
view: functional_movement_assessments {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `strength_and_conditioning.functional_movement_assessments` ;;
